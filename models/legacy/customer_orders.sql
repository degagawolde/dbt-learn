...
FROM analytics.dbt_dwolde.orders as Orders
...
left join analytics.dbt_dwolde.customers C on orders.USER_ID = C.ID ),
...
left join analytics.dbt_dwolde.orders as Orders
